  ...
  const handleCanvasExport = async (format: 'png' | 'jpg' = 'png') => {
    ...
    try {
      ...
      drawText(
        ...
        if (positiveLabelPos) {
      drawText(
        textModules.positiveRatingLabel || 'نسبة التقييم',
            ...
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <div 
                style={{
                  ...
                  color: textStyles.studentsServed?.color || '#ffffff',
          ...
          >
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <div 
                className="text-[6px] leading-tight"
                style={{
                  color: textStyles.positiveRatingLabel?.color || '#ffffff',
                  fontWeight: textStyles.positiveRatingLabel?.fontWeight || 'normal',
                  whiteSpace: 'nowrap',
                  direction: 'rtl',
                  textAlign: 'center'
                }}
              >
                {textModules.positiveRatingLabel || 'نسبة النجاح'}
              </div>
              {showCoordinates && (
                <div
                  style={{
